...
export default class privacyPolicy extends React.Component {
    ...
    return (
        ...
        <span>Last updated: 17/11/2019</span>
        
        <p>LMG, operates www.lmg-bouwwerken.be. This page informs you of our policies regarding the collection, use and disclosure of Personal Information we receive from users of the Site.</p>
        ...
        <p>Additionally by visiting this website, you automatically agree on the TOS displayed by <a href="https://marketingplatform.google.com/about/analytics/terms/us/"> GOOGLE ANALYTICS</a>.</p>
        ...
        <p>This Privacy Policy is effective as of 17/11/2019 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.</p>
